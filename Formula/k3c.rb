...
class K3c < Formula
  ...
  if Hardware::CPU.arm?
    url "https://github.com/philipparndt/k3c/releases/download/v0.12.15/k3c_darwin_arm64.tar.gz"
    sha256 "b2b15b860ffe6f9357176124b4830d9b09f6ca0684b423c06f3cc5355dbe5ff4"
