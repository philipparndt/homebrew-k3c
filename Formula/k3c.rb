...
class K3c < Formula
  ...
  if Hardware::CPU.arm?
    url "https://github.com/philipparndt/k3c/releases/download/v0.12.5/k3c_darwin_arm64.tar.gz"
    sha256 "fb417687fc48f2c6dbe95fb6983c730101b2964903080e8d9e597a55dbc8e0d0"
