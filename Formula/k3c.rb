...
class K3c < Formula
  ...
  if Hardware::CPU.arm?
    url "https://github.com/philipparndt/k3c/releases/download/v0.6.12/k3c_darwin_arm64.tar.gz"
    sha256 "c3db7714e7efd4f4d6e6653675323cc338044f92a7f4ebee8f1088e727646e4c"
