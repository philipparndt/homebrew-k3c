...
class K3c < Formula
  ...
  if Hardware::CPU.arm?
    url "https://github.com/philipparndt/k3c/releases/download/v0.26.0/k3c_darwin_arm64.tar.gz"
    sha256 "f7279452c88b9a97c816de915c353a78bca08a326c525371c547aa8e2b806de1"
