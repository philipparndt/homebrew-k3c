...
class K3c < Formula
  ...
  if Hardware::CPU.arm?
    url "https://github.com/philipparndt/k3c/releases/download/v0.12.0/k3c_darwin_arm64.tar.gz"
    sha256 "98b459d9a5a8f5e82c7717f580180932ed774500992ad55a96bfec93a0c697ff"
