...
class K3c < Formula
  ...
  if Hardware::CPU.arm?
    url "https://github.com/philipparndt/k3c/releases/download/v0.10.0/k3c_darwin_arm64.tar.gz"
    sha256 "33345321e3e18476eadef563d0dccd8d4915e6e72ccff7d0b90be31badfa2c34"
