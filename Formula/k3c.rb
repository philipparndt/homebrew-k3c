...
class K3c < Formula
  ...
  if Hardware::CPU.arm?
    url "https://github.com/philipparndt/k3c/releases/download/v0.24.1/k3c_darwin_arm64.tar.gz"
    sha256 "1d320851694026a1f0d8eca946714101f08cc63aaecf8dffc842deb23c573775"
