...
class K3c < Formula
  ...
  if Hardware::CPU.arm?
    url "https://github.com/philipparndt/k3c/releases/download/v0.16.4/k3c_darwin_arm64.tar.gz"
    sha256 "78492fa0a66fbc6bf3b15f819e3e66928613886a2be09ebd5b8681da6c06619b"
