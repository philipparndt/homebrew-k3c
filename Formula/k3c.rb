...
class K3c < Formula
  ...
  if Hardware::CPU.arm?
    url "https://github.com/philipparndt/k3c/releases/download/v0.12.12/k3c_darwin_arm64.tar.gz"
    sha256 "6a543b2784c02b576df8944686619fd42969a6a20793510b9c76eb2fa4ef9634"
