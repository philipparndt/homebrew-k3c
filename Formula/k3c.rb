...
class K3c < Formula
  ...
  if Hardware::CPU.arm?
    url "https://github.com/philipparndt/k3c/releases/download/v0.25.1/k3c_darwin_arm64.tar.gz"
    sha256 "58f24d7da206affa2456a4ae42bfbbd5c12aff08b5e6b126364c35ab523ab90f"
