...
class K3c < Formula
  ...
  if Hardware::CPU.arm?
    url "https://github.com/philipparndt/k3c/releases/download/v0.8.1/k3c_darwin_arm64.tar.gz"
    sha256 "cde54a540601c2986678f364597e5a0ef3a54da620deaa1336e9099a4c7db042"
