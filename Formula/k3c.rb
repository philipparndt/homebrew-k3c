...
class K3c < Formula
  ...
  if Hardware::CPU.arm?
    url "https://github.com/philipparndt/k3c/releases/download/v0.12.7/k3c_darwin_arm64.tar.gz"
    sha256 "c120f1aa0ec4c2f0e5d2d5e57112948dfbbce396084199361936bc9301bbe7d8"
