...
class K3c < Formula
  ...
  if Hardware::CPU.arm?
    url "https://github.com/philipparndt/k3c/releases/download/v0.12.8/k3c_darwin_arm64.tar.gz"
    sha256 "016a613366772032a6d785d7069aa408fdc2317e88c68777f7a79f9f377fd1b9"
