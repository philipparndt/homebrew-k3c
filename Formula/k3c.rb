...
class K3c < Formula
  ...
  if Hardware::CPU.arm?
    url "https://github.com/philipparndt/k3c/releases/download/v0.6.13/k3c_darwin_arm64.tar.gz"
    sha256 "65cbe71a2a2068c2c96081cd3d831989e1e89648d49dd5943f06db54a71cd8e6"
