...
class K3c < Formula
  ...
  if Hardware::CPU.arm?
    url "https://github.com/philipparndt/k3c/releases/download/v0.12.6/k3c_darwin_arm64.tar.gz"
    sha256 "b2baf59c5d2b4a48bca9be614d5f62275327a50b05a209361a4eebb27fac58a8"
