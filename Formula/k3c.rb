...
class K3c < Formula
  ...
  if Hardware::CPU.arm?
    url "https://github.com/philipparndt/k3c/releases/download/v0.12.13/k3c_darwin_arm64.tar.gz"
    sha256 "434df387f03348ca911b5cb1efc86db7965a3b8a1d17293c3fac82d6853628fc"
