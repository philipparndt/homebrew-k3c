...
class K3c < Formula
  ...
  if Hardware::CPU.arm?
    url "https://github.com/philipparndt/k3c/releases/download/v0.6.7/k3c_darwin_arm64.tar.gz"
    sha256 "b9e687ed98a2eeffbc00e9a672cd60d963fdae96ca29954501771518d76f70c3"
